# Ars Magica Definitive Edition – Allgemeine Spielbegriffe / General Game Terms

**Teil der deutschen Übersetzungstabellen** | Quellen: ArM_DE_Uebersetzungstabelle.md (Sek. 1, 4–6) · ArM_DE_Zusatztermini.md
...
## Allgemeine Spielbegriffe / General Game Terms

| Englisch (EN) | Lat. m./n. Sg. | Lat. f. Sg. | Lat. m./n. Pl. | Lat. f. Pl. | Deutsch (DE) | Anmerkung |
|---|---|---|---|---|---|---|
| Apprentice | – | – | – | – | Lehrling | Azubi eines Magus, 15 Jahre Ausbildung |
| Arcane Connection | – | – | – | – | Arkane Verbindung | Okkulte Verbindung zu Person/Objekt |
| Archimagus | Archimagus | Archimaga | Archimagi | Archimagae | Erzmagus / Erzmaga | Ehrentitel für mächtige Magi |
| Aura | – | Aura | – | Aurae | Aura | Übernatürliche Kraft eines Herrschaftsbereichs |
| Autocrat / Maior Domus | Maior Domus | Maior Domus | Maiores Domus | Maiores Domus | Maior Domus | Weltlicher Verwalter eines Konvents |
| Botch | – | – | – | – | Patzer | Kritischer Misserfolg beim Würfeln |
| Botch Dice | – | – | – | – | Patzerwürfel | Anzahl Würfel bei Stresswurf; im Text (Zeile ~175) einmalig fälschlich als „Stresswürfel" bezeichnet – korrekt ist „Patzerwürfel" |
| Casting Score | – | – | – | – | Zauberwert | Grundwert für das Zaubern (Technik + Form + Ausdauer – Behinderung + Auramodifikator) |
| Casting Tablet | – | – | – | – | Zaubertafel | Schrifttafel zum Wirken nicht erlernter Zauber (f.) |
| Casting Total | – | – | – | – | Zaubersumme | Gesamtwert für das Zaubern (beinhaltet i. A. den Zauberwert + Würfelwurf) |
| Certamen | Certamen (n.) | – | Certamina | – | Certamen | Nicht-tödliches magisches Duell |
| Characteristic + Ability total | – | – | – | – | Eigenschaft + Fertigkeit-Gesamtwert | Langer zusammengesetzter Begriff; im Text konsistent so verwendet |
| Code of Hermes | – | – | – | – | Kodex des Hermes | Verhaltensregeln des Ordens |
| Companion | – | – | – | – | Gefährte | Nicht-Magus-Hauptcharakter |
| Confidence | – | – | – | – | Selbstvertrauen | Oberbegriff für Selbstvertrauenspunkte und Selbstvertrauenswert |
| Confidence Points | – | – | – | – | Selbstvertrauenspunkte | Aktuell verfügbare Menge an Selbstvertrauen |
| Confidence Score | – | – | – | – | Selbstvertrauenswert | Maximale Selbstvertrauenspunkte, die in einem Wurf ausgegeben werden dürfen |
| Consors | Consors | Consors | Consortes | Consortes | Consors | Enger Nicht-Magus-Mitarbeiter des Konvents |
| Covenant | Conventus | Conventus | Conventus | Conventus | Konvent | Wohngemeinschaft hermetischer Magi (4. Dekl., Pl. = Sg.) |
| Cult of Mercury | – | – | – | – | Kult des Merkur | Vorgänger des Orden des Hermes |
| Custos | Custos | Custos | Custodes | Custodes | Custos | Offizieller Begriff für Grogs |
| Decrepitude | – | – | – | – | Gebrechlichkeit | Wert, der körperlichen Verfall abbildet |
| Demon | – | – | – | – | Dämon | Kreatur der Hölle |
| Diabolist | – | – | – | – | Diabolist | Teufelsanbeter |
| The Divine | – | – | – | – | Das Göttliche | |
| The Divine Realm | – | – | – | – | Die Göttliche Sphäre | Übernatürliche Sphäre der Heiligen Kirche |
...
| Faerie Realm | – | – | – | – | Feensphäre | Übernatürliche Herrschaftssphäre der Feen |
...
| The Gift | – | – | – | – | Die Gabe | Angeborene Fähigkeit zur Magie |
| Grand Tribunal | – | – | – | – | Großtribunal | Alle-33-Jahre-Treffen in Durenmar |
...
| Longevity Ritual | – | – | – | – | Langlebigkeitsritual | Ritual zur Verlängerung des Lebens |
| Low Crime / Minor Crime | – | – | – | – | Niederes Vergehen | Verstoß gegen den Peripheren Kodex |
| Magic (Realm) | – | – | – | – | Magie (Sphäre) | Übernatürliche Sphäre der Magie |
| Magic Resistance | – | – | – | – | Magieresistenz | Widerstand gegen Magie |
| Magus / Maga | Magus | Maga | Magi | Magae | Magus / Maga | Meister der hermetischen Künste |
| March (Wizard's March) | – | – | – | – | Zug der Magier | Jagd auf einen ausgestoßenen Magus |
| Might | – | – | – | – | Macht | Kreaturenwert |
| Might Score | – | – | – | – | Machtwert | |
| Mundane | – | – | – | – | Sterblicher | Normaler, nicht-magischer Mensch |
| Mystery Cult | – | – | – | – | Mysterienkult | |
| Mythic Companion | – | – | – | – | Mythischer Gefährte | Mächtiger Nicht-Magus-Spielercharakter |
| Mythic Europe | – | – | – | – | Mythisches Europa | Die Spielwelt von Ars Magica |
| Order of Hermes | – | – | – | – | Orden des Hermes | Der hermetische Magierorden |
| Orbus / Orba | Orbus | Orba | Orbi | Orbae | Orbus / Orba | Aus dem Haus ausgeschlossener Magus |
| Parens | Parens | Parens | Parentes | Parentes | Parens | Vormaliger Meister / Lehrmeisterin |
| Parma Magica | – | Parma Magica | – | Parmae Magicae | Parma Magica | Magischer Schutzschild gegen Magie; **Parma Magica im Deutschen weiblich** |
| Pater / Mater | Pater | Mater | Patres | Matres | Pater / Mater | Synonym für Parens |
| Penetration | – | – | – | – | Penetration | Wert für das Durchdringen magischer Abwehr |
| Peripheral Code | – | – | – | – | Peripherer Kodex | Zusätze und Präzedenzfälle zum Kodex |
| Praeco | Praeco | Praeco | Praecones | Praecones | Praeco | Vorsitzender Magus eines Tribunals |
| Pretenses | – | – | – | – | Täuschungen | Besondere Fähigkeiten von Feenwesen; nicht mit Fertigkeit „Guile" (Täuschung) verwechseln |
| Primus / Prima | Primus | Prima | Primi | Primae | Primus / Prima | Vorsitzender eines Hauses |
| Quaesitor | Quaesitor | Quaesitrix | Quaesitores | Quaesitrices | Quaesitor | Hüter des Kodex, Richter des Ordens |
| Raw Vis | – | – | – | – | Rohes Vis | Vis in physischer Form |
...
| Ritual Magic | – | – | – | – | Ritualmagie | Langwieriger Formalzauber mit Vis |
| Saga | – | – | – | – | Saga | Die gesamte Kampagne / Spielgeschichte |
| Sanctum | Sanctum (n.) | – | Sancta | – | Sanctum | Privatgemächer eines Magus |
| The Schism War | – | – | – | – | Der Schismakrieg | Krieg gegen Haus Diedne (frühes 11. Jh.) |
| Scrying | – | – | – | – | Ausspähen | Verbotene Überwachung von Magi |
| Season (game time) | – | – | – | – | Quartal | Spielzeiteinheit (Frühling/Sommer/Herbst/Winter) |
...
| Story | – | – | – | – | Geschichte | Einzelne Spielsitzung / Abenteuer |
| Storyguide | – | – | – | – | Spielleiter | Spielleiterin / Erzähler (ArM4) |
| Stress Die / Stress Roll | – | – | – | – | Stresswurf / Stresswürfel | „Stresswurf" = Spielmechanik (Wurfaktion); „Stresswürfel" = das physische Würfelobjekt – beide Formen korrekt und kontextabhängig |
| Talisman | – | – | – | – | Talisman | Besonders gebundenes magisches Objekt |
| the nearby insert | – | – | – | – | der nebenstehende Kasten | Layoutbezogener Begriff |
| Tribunal | – | – | – | – | Tribunal | Regionaltreffen der Magi; auch: die Region |
| Troupe | – | – | – | – | Spieltruppe | Gruppe aller Spieler und Spielleiter |
...
| Englisch (EN) | Abk. (EN) | Deutsch (DE) | Abk. (DE) |
|---|---|---|---|
| Strength | Str | Stärke | Stä |
| Stamina | Sta | Ausdauer | Aus |
| Dexterity | Dex | Geschicklichkeit | Ges |
| Quickness | Qik | Schnelligkeit | Sck |
...
## Wundenstufen / Wound Levels

| Englisch (EN) | Deutsch (DE) | Anmerkung |
|---|---|---|
| Graze | Kratzer | Minimaler Schaden |
| Light Wound | Leichte Wunde | |
| Medium Wound | Mittelschwere Wunde | |
| Heavy Wound | Schwere Wunde | |
| Incapacitating Wound | Lähmende Wunde | |
| Dead | Tot | |

---

## Erschöpfungsstufen / Fatigue Levels
