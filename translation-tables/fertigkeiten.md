# Ars Magica Definitive Edition – Fertigkeiten / Abilities

**Teil der deutschen Übersetzungstabellen** | Quelle: ArM_DE_Uebersetzungstabelle.md (Sek. 15)

**Legende:**
- (Lat.) = Lateinischer Begriff, wird unübersetzt beibehalten
- \* = Fertigkeit, die ohne mindestens 1 Erfahrungspunkt nicht einsetzbar ist (ArMDE, S. 157)

---

## Fertigkeiten / Abilities
...
| Athletics | Allgemein | Athletik | |
| Awareness | Allgemein | Aufmerksamkeit | |
| Bargain | Allgemein | Feilschen | |
| Bows | Kampf | Bogenschießen | |
| Brawl | Allgemein | Raufen | |
| Carouse | Allgemein | Zechen | |
| Charm | Allgemein | Charme | |
| Chirurgy\* | Allgemein | Chirurgie | |
| Civil and Canon Law\* | Akademisch | Zivil- und Kanonisches Recht | |
| Code of Hermes\* | Arkan | Kodex des Hermes | |
| Common Law\* | Akademisch | Gewohnheitsrecht | |
| Concentration | Allgemein | Konzentration | |
| Corpse Magic\* | Übernatürlich | Leichenmagie | |
| Craft (Type) | Allgemein | Handwerk (Art) | |
| Crafter's Healing\* | Übernatürlich | Handwerkerheiler | |
...
| Enigmatic Wisdom\* | Arkan | Enigmatische Weisheit | Criamon |
| Entrancement\* | Übernatürlich | Betörung | |
| Etiquette | Allgemein | Etikette | |
| Faerie Lore\* | Arkan | Feenkunde | |
| Faerie Magic\* | Arkan | Feenmagie | |
...
| Hex\* | Übernatürlich | Verhexung | |
| Hunt | Allgemein | Jagen | |
...
| Legerdemain\* | Allgemein | Fingerfertigkeit | |
| Magic Lore\* | Arkan | Magiekunde | |
| Magic Sensitivity\* | Übernatürlich | Magiegespür | |
...
| Philosophiae\* | Akademisch | Philosophiae | Lat., behalten |
| Premonitions\* | Übernatürlich | Vorahnungen | |
| Profession (Type) | Allgemein | Beruf (Art) | |
| Rabbinic Law\* | Akademisch | Rabbinisches Recht | |
| Ride | Allgemein | Reiten | |
| Second Sight\* | Übernatürlich | Zweites Gesicht | |
| Sense Holiness and Unholiness\* | Übernatürlich | Gespür für Heiliges und Unheiliges | |
| Sense Passions\* | Übernatürlich | Gespür für Leidenschaft | |
| Shapeshifter\* | Übernatürlich | Gestaltwandler | |
| Single Weapon | Kampf | Einzelwaffe | |
| Stealth | Allgemein | Schleichen | |
| Summon Animals\* | Übernatürlich | Tiere rufen | |
| Survival | Allgemein | Überleben | |
| Swim | Allgemein | Schwimmen | |
| Teaching | Allgemein | Unterrichten | |
| Theology: Christian\* | Akademisch | Theologie: Christlich | |
| Theology: Islam\* | Akademisch | Theologie: Islam | |
| Theology: Judaism\* | Akademisch | Theologie: Judentum | |
| Thrown Weapon | Kampf | Wurfwaffe | |
| Whistle Up The Wind\* | Übernatürlich | Den Wind herbeipfeifen | |
| Wilderness Sense\* | Übernatürlich | Natursinn | |
...
*Quellen: Ars Magica Definitive Edition Core Rules (Atlas Games, 2024) · Ars Magica 5e – Sphären der Macht: Magie (Atlas Games) · Ars Magica 5e – Sphären der Macht: Das Göttliche (Atlas Games) · Houses of Hermes: True Lineages (Atlas Games, 2005)*
